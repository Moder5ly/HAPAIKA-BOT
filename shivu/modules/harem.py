...
async def harem(update: Update, context: CallbackContext, page=0) -> None:
    ...
    keyboard = [[InlineKeyboardButton(f"Оглянути гарем ({total_count})", switch_inline_query_current_chat=f"collection.{user_id}")]]
    ...
    if 'favorites' in user and user['favorites']:        
        ...
        if user['characters']:
            ...
            if update.message:
                await update.message.reply_text("Список порожній. Саме час його заповнювати!")

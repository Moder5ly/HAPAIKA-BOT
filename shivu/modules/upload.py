...
#            return
        ...
        event_name = event_map[int(args[3])]

        character = {
            'img_url': args[0],
            'name': character_name + " " + event_name[0],
